...
NICKNAME = 'DAEJEON02_PARKSUHYUNG'
...
while True:
    ...
    """
    강의자료를 기반으로 1, 3, 8 번의 목적구를 순서대로 타격해 포켓에 넣는 것을 유도한다.
    흰공을 중심으로 각 사분면일 때 각도에 추가적으로 값을 주어 원하는 방향으로 나아가게 한다.
    """
